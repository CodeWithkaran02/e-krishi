...
<head>
  <title>e-krishi darshan|Home</title>
  ...
  <div id="main">
                  ...
                  <ul>
                    <li class="slide">
                      <div>
                        ...
                        <p>
                          <img src="images/info4.gif" width="123" height="90" border="0" alt="view" />
                        </p>
                      </div>
                    </li>
                    <li class="slide">
                      <div>
                        ...
                        <p>
                          <img src="images/info5.gif" width="133" height="90" border="0" alt="view" />
                        </p>
                      </div>
                    </li>
                  </ul>
            ...
            <div class="inner">
              ...
              <form method="post" action="<?php echo $_SERVER["PHP_SELF"]; ?>" id="signup-form">
                <fieldset>
                  ...
                  <br> <br />
                  <center>
                    <input type="submit" name="s1" id="s1" value="Log In" class="button">
                  </center>
          ...
          <div class="indent">
            ...
            <div class="wrapper line-ver">
              ...
              <div class="col-2">
                ...
                <p class="t1">We are located in the Basic Building of Science, center of Ranchi surrounded by morabadi campus Ranchi.</p><br />
                <dl class="contacts-list">
                  <dt>Univ. Dept. of MCA</dt>
    ...
    <div id="footer">
      ...
      <div class="wrapper">
        ...
        <div class="fright">Designed by KARUNA KARAN - <a href="#">Roll No. 21MCAMS97047</a> Semester IV</div>
      </div>
    </div>
  </div>
