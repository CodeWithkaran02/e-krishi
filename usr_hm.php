...
<body id="page1" onload="new ElementMaxHeight();">
      ...
      <div class="row-1">
        <div class="wrapper">
          ...
          <div class="phones"> Call Us+91-9060319668<br />
            <span class="txt_cl">
              <a href="login_option.php">LOG OUT ! ! !</a></span>
          </div>
        </div>
      </div>
                ...
                <div class="slice2" id="slider">
                  <ul>
                    <li class="slide">
                      <div>
                        <p class="img">
                          <img src="images/2page-img10.jpg" width="483" height="272" />
                        </p>
        ...
        <center>
          <table border="2" bordercolor="#339900" align="center" cellpadding="5" cellspacing="8" class="fnt">
            ...
            ?> <tr align="center">
                ...
                <td> <?php echo $rcrop_rs['discount']; ?>%</td>
              </tr>
            <?php  } ?>
          </table>
        </center>
        ...
        <center>
          <table border="2" bordercolor="#339900" align="center" cellpadding="5" cellspacing="8" class="fnts">
            ...
            ?> <tr align="center">
                ...
                <td> <?php echo $kcrop_rs['discount']; ?>%</td>
              </tr>
            <?php  } ?>
          </table>
        </center>
  ...
  <div align=center>University Department of MCA Cell, Ranchi University, Ranchi Jharkhand, INDIA</div>
</body>
