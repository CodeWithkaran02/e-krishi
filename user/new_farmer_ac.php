...
<body>
  ...
  <div class="icn">
    ...
    <center><span class="txt">
        e-KRISHI DARSHAN</span><span class="blk">a complete farmer's solutions</span></center>
        ...
        <div class="slice2" id="slider">
          <ul>
            <li class="slide">
              <div>
                <p class="img">
                  <img src="../images/simple_text_img_1.jpg" width="483" height="272" />
                </p>
                <h2>Need help?</h2>
  ...
  <div class="info">
              ...
              <table height="90%" width="100%" class="fnt" bgcolor="#CC99FF">
                ...
                <tr bgcolor="#CCCCCC">
                  <td colspan="3">
                    ...
                    I agree for post the product and I accept all the terms and conditions
                  </td>
                </tr>
                <tr bgcolor="#FFFFFF">
                  <td class="t">
                    <input style="font-weight: bold;" type="submit" class="submit_btn" name="submit" id="submit" value=" SUBMIT " />
                  </td>
    ...
    <div class="taskbar">
      Designed by:
      Karuna Karan Mater of Computer Application semester-IV
      <hr>
      e-krishi darshan -A complete krishi solutions&copy; all copyrights reserved 2023
      <div class="up_a">
